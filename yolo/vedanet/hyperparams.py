...
class HyperParams(object):
    def __init__(self, config, train_flag=1):
        ...
        if train_flag == 1:
            ...
            self._dataset = cur_cfg['dataset']
            self._trainfile = f'{self.data_root}/{self._dataset}'
            self.trainfile = f"{self._trainfile}.pkl"
            ...
            self._dataset = cur_cfg['self._dataset']
            self.testfile = f'{self.data_root}/{self._dataset}.pkl'
            self.nworkers = cur_cfg['nworkers']
            self.pin_mem = cur_cfg['pin_mem']
            self.network_size = cur_cfg['input_shape']
            self.batch = cur_cfg['batch_size']
